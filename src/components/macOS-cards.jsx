  ...
  <div>
	...
	<Card className="mt-5 mb-5 border-0 text-dark">
		...
		<Media>
			...
			<Image src={post.frontmatter.image.relativePath} rounded className="mb-3 border border-dark" width={120} height={90} alt={post.frontmatter.alt}/>
		</Media>
		<Card.Text style={{fontSize: '14px'}}>{post.frontmatter.subtitle}</Card.Text>
		</Card.Body>
	</Card>
	</React.Fragment>
  </div>
